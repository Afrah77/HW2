...
- yes, because at buzzfeed we analyze the data to find more understanding of the data and obtain information. We go in depth and make a lot of filtering to understand the data
...
nobel_living_science <-nobel_living_science %>%
  mutate(
    born_country_us = if_else(born_country == "USA", "USA", "Other"))
nobel_living_science %>% 
  ggplot(aes(x  =  country_us, y=born_contry_us, fill =category)) +
geom_bar(stat = "identity" , position = "dodge" , orientation="horizontal" )
```
